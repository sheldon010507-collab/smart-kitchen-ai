...
const tools = [
  ...
  { name: 'kitchen_suggest_reorder', description: 'Suggest low-stock reorders using Kitchen Wiki par_level and recent order history.', inputSchema: { type: 'object', properties: { ...actorFields, ...businessFields }, required: ['telegram_user_id'] } },
