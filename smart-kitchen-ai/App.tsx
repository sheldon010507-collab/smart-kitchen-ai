...
import { InventorySetupWizard } from './components/setup';
...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-background text-primary font-sans flex flex-col md:flex-row">
        ...
        <div className="p-6 md:p-16 max-w-6xl mx-auto min-h-screen">
          ...
          {view === ViewState.SHOPPING && (
            currentBusinessId ? (
              ...
              <div className="space-y-8">
                <header>
                  <h2 className="text-3xl font-bold text-primary tracking-tight">Shopping List</h2>
                  <p className="text-secondary mt-2">Select a store to view its shopping list</p>
                </header>
                <div className="flex flex-col items-center justify-center py-20 border-2 border-dashed border-border rounded-xl">
                  <ShoppingCart className="w-16 h-16 text-border mb-4" />
                  <h3 className="text-lg font-bold text-primary mb-2">No Store Selected</h3>
                  <p className="text-secondary text-center max-w-md">
                    Please select a store from the dropdown to view its shopping list.
                  </p>
                </div>
              </div>
            )
      ...
      {isSetupWizardOpen && currentBusinessId && (
